...
namespace StagPoint.Examples
{
	...
	[AddComponentMenu( "StagPoint/Examples/Object Pooling/Object Pool Manager" )]
	[Serializable]
	public class PoolManager : MonoBehaviour
	{
		...
		/// <summary>
		/// Singleton instance of the <see cref="PoolManager"/> class
		/// </summary>
...
#pragma warning restore 0168
		...
		public class ObjectPool
		{
			...
			private ListEx<GameObject> pool = new ListEx<GameObject>();
			private ListEx<GameObject> spawned = new ListEx<GameObject>();
			...
			public void Despawn( GameObject instance )
			{
				...
				var component = instance.GetComponent<PooledObject>();
				if( component != null )
				{
				...
				if( allowReparenting && PoolManager.Pool != null )
				{
					instance.transform.parent = PoolManager.Pool.transform;
				}
			...
			private void spawnInstance( GameObject instance, bool activate )
			{
				...
				// Find the PooledObject component and notify any observers of the spawn event
				var poolComponent = instance.GetComponent<PooledObject>();
			...
			private GameObject Instantiate()
			{
				...
				instance.name = string.Format( "{0} {1}", PoolName, ++spawnCounter );
				...
				if( poolComponent == null )
				{
					poolComponent = instance.AddComponent<PooledObject>();
				}
